...
<%
	String realPath = "C:\\NamDawon\\javafullstack2021_03_08\\workspace\\servlet-practices\\fileupload\\src\\main\\webapp\\uploadFile";
   ...
   // String sDownPath = request.getRealPath(savePath);
    ...
    System.out.println("다운로드 폴더 절대 경로 위치 : " + realPath);
    System.out.println("fileName1 : " + fileName);
     
    // 저장되어 있는 폴더경로/저장된 파일명 으로 풀 path를 만들어준다.
        // 자바에서는 \를 표시하기 위해서는 \를 한번 더 붙여주기 때문에 \\로 해준다.
    String sFilePath = realPath +"\\" + fileName;// ex)c:\\uploadPath\\image.jpg
